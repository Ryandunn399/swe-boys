...
public class ConversionTests {
     ...
     */
    @Test
    public void testPathThree() throws IOException, ServletException {
        StringWriter writer = new StringWriter();
        PrintWriter out = new PrintWriter(writer);
        when(req.getParameter("F")).thenReturn("1");
        when(req.getParameter("in")).thenReturn("1");
        ...
        assertEquals(getTestThreeOracle(), writer.toString());
    }
     ...
     */
    @Test
    public void testPathFour() throws IOException, ServletException {
        StringWriter writer = new StringWriter();
        PrintWriter out = new PrintWriter(writer);
        when(req.getParameter("C")).thenReturn("1");
        when(req.getParameter("cm")).thenReturn("1");
        ...
        assertEquals(getTestFourOracle(), writer.toString());
    }
    ...
    public static String getTestThreeOracle() {
        StringWriter writer = new StringWriter();
        PrintWriter out = new PrintWriter(writer);
        out.println ("<html>");
        out.println ("<head>");
    ...
    public static String getTestFourOracle() {
        StringWriter writer = new StringWriter();
        PrintWriter out = new PrintWriter(writer);
        out.println ("<html>");
        out.println ("<head>");
